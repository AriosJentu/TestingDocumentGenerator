...
class Assignment:
	...
	- 'module' - Module object which respects to this assignment class. Must be stay default, sets in generation automatically. Helps to detect 'module' path
	...
	def generate(self, 
		...
		#Then generate Document object with containing pages information (with update layout module)
